...
#        paths = cypher_load_graph("START n=node(*) MATCH (n)-[r]->(m) RETURN n,r,m;")
#        paths = cypher_load_graph("MATCH (n) OPTIONAL MATCH (n)-[r]-(m) RETURN n,r,m")
        ...
        print('Are you input correctly in Cypher Syntax')
...
def isomorphism_subgraph_matching():
    ...
    print(subgraph_list)
#    GM = isomorphism.GiGraphMatcher(DG,QG,node_match=isomorphism.categorical_node_match(['material', 'size'],['metal',1]))
#    print(GM)
